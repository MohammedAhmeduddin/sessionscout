        ...
        sessions.append(
            {
                ...
                "events": [
                    ...
                    {
                        "aid": 1,
                        "ts": float(1_000_000 + i * 1000 + 60),
                        "type": "clicks",
                    },
                    {
                        "aid": 1,
                        "ts": float(1_000_000 + i * 1000 + 120),
                        "type": "carts",
                    },
                    {
                        "aid": 1,
                        "ts": float(1_000_000 + i * 1000 + 180),
                        "type": "orders",
                    },
                ],
            }
...
class TestBuildSequenceDataset:
    def test_with_retailrocket_only(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            cfg.paths, "sequences_parquet", processed / "sequences.parquet"
        )
    ...
    def test_custom_save_path(self, tmp_path, monkeypatch):
        ...
        build_sequence_dataset(save_path=out)
        assert out.exists()
